...
export default function storeReducer(store, action = {}) {
  switch (action.type) {
    ...
    case 'cargar_visitados':
      return { ...store, yaVisitados: action.payload };
    case 'cargar_favoritos':
      return { ...store, misFavoritos: action.payload };
      
    case 'cargar_guardados':
      return { ...store, guardados: action.payload };
    case 'cargar_descartados':
      return { ...store, descartados: action.payload };
