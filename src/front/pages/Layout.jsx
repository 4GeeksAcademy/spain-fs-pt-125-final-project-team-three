...
export const Layout = () => {
    ...
    useEffect(() => {
        const checkUserSession = async () => {
            ...
            try {
                const response = await fetch("https://scaling-dollop-974v94jqq446fxxw4-3001.app.github.dev/api/profile", {
                    method: "GET",
                    headers: {
                ...
                if (response.ok) {
                    ...
                    dispatch({
                        type: "cargar_visitados",
                        payload: data.visitados
                    });
                    dispatch({ 
                    ...
                    dispatch({ 
                        type: "cargar_guardados", 
                        payload: data.guardados 
                    });
                    dispatch({ 
                        type: "cargar_descartados", 
                        payload: data.descartados 
                    });
